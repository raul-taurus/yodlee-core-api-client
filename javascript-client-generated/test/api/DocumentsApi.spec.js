...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.DocumentsApi();
  });
    ...
    describe('DocumentsApi', function() {
      describe('deleteDocument', function() {
        it('should call deleteDocument successfully', function(done) {
          ...
          instance.deleteDocument(documentId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('downloadDocument', function() {
        it('should call downloadDocument successfully', function(done) {
          ...
          instance.downloadDocument(documentId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(YodleeCoreApis.DocumentDownloadResponse);
      ...
      describe('getDocuments', function() {
        it('should call getDocuments successfully', function(done) {
          ...
          instance.getDocuments(opts, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(YodleeCoreApis.DocumentResponse);
