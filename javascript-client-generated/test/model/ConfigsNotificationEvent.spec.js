...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigsNotificationEvent', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.ConfigsNotificationEvent();
      });

      it('should create an instance of ConfigsNotificationEvent', function() {
        // TODO: update the code to test ConfigsNotificationEvent
        expect(instance).to.be.a(YodleeCoreApis.ConfigsNotificationEvent);
      });
