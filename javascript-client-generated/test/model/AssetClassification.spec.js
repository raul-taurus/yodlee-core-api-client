  ...
  describe('(package)', function() {
    describe('AssetClassification', function() {
      ...
      it('should create an instance of AssetClassification', function() {
        // TODO: update the code to test AssetClassification
      ...
      it('should have the property allocation (base name: "allocation")', function() {
        // TODO: update the code to test the property allocation
        expect(instance).to.have.property('allocation');
        // expect(instance.allocation).to.be(expectedValueLiteral);
      });
