...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TotalCount', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.TotalCount();
      });

      it('should create an instance of TotalCount', function() {
        // TODO: update the code to test TotalCount
        expect(instance).to.be.a(YodleeCoreApis.TotalCount);
      });
