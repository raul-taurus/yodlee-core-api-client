...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CobrandNotificationEvent', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.CobrandNotificationEvent();
      });

      it('should create an instance of CobrandNotificationEvent', function() {
        // TODO: update the code to test CobrandNotificationEvent
        expect(instance).to.be.a(YodleeCoreApis.CobrandNotificationEvent);
      });
