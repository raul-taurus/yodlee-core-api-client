  ...
  describe('(package)', function() {
    describe('VerificationStatus', function() {
      ...
      it('should have the property remainingAttempts (base name: "remainingAttempts")', function() {
        // TODO: update the code to test the property remainingAttempts
        expect(instance).to.have.property('remainingAttempts');
        // expect(instance.remainingAttempts).to.be(expectedValueLiteral);
      });
