...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifiedAccountResponse', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.VerifiedAccountResponse();
      });

      it('should create an instance of VerifiedAccountResponse', function() {
        // TODO: update the code to test VerifiedAccountResponse
        expect(instance).to.be.a(YodleeCoreApis.VerifiedAccountResponse);
      });
      ...
      it('should have the property verifiedAccount (base name: "verifiedAccount")', function() {
        // TODO: update the code to test the property verifiedAccount
        expect(instance).to.have.property('verifiedAccount');
        // expect(instance.verifiedAccount).to.be(expectedValueLiteral);
      });
