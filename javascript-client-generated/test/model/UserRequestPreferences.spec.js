...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserRequestPreferences', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.UserRequestPreferences();
      });

      it('should create an instance of UserRequestPreferences', function() {
        // TODO: update the code to test UserRequestPreferences
        expect(instance).to.be.a(YodleeCoreApis.UserRequestPreferences);
      });
