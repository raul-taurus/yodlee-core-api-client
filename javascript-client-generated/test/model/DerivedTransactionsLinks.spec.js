...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DerivedTransactionsLinks', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.DerivedTransactionsLinks();
      });

      it('should create an instance of DerivedTransactionsLinks', function() {
        // TODO: update the code to test DerivedTransactionsLinks
        expect(instance).to.be.a(YodleeCoreApis.DerivedTransactionsLinks);
      });
