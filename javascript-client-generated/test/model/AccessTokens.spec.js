...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccessTokens', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.AccessTokens();
      });

      it('should create an instance of AccessTokens', function() {
        // TODO: update the code to test AccessTokens
        expect(instance).to.be.a(YodleeCoreApis.AccessTokens);
      });
