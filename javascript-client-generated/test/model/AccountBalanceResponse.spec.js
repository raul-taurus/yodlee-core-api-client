...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountBalanceResponse', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.AccountBalanceResponse();
      });

      it('should create an instance of AccountBalanceResponse', function() {
        // TODO: update the code to test AccountBalanceResponse
        expect(instance).to.be.a(YodleeCoreApis.AccountBalanceResponse);
      });
