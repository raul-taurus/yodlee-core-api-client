  ...
  describe('(package)', function() {
    describe('DerivedTransactionsSummary', function() {
      ...
      it('should create an instance of DerivedTransactionsSummary', function() {
        // TODO: update the code to test DerivedTransactionsSummary
      ...
      it('should have the property categorySummary (base name: "categorySummary")', function() {
        // TODO: update the code to test the property categorySummary
        expect(instance).to.have.property('categorySummary');
        // expect(instance.categorySummary).to.be(expectedValueLiteral);
      });
