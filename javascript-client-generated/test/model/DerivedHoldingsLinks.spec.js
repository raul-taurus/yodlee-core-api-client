...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DerivedHoldingsLinks', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.DerivedHoldingsLinks();
      });

      it('should create an instance of DerivedHoldingsLinks', function() {
        // TODO: update the code to test DerivedHoldingsLinks
        expect(instance).to.be.a(YodleeCoreApis.DerivedHoldingsLinks);
      });
