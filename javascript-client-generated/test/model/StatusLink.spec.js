...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StatusLink', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.StatusLink();
      });

      it('should create an instance of StatusLink', function() {
        // TODO: update the code to test StatusLink
        expect(instance).to.be.a(YodleeCoreApis.StatusLink);
      });

      it('should have the property methodType (base name: "methodType")', function() {
        // TODO: update the code to test the property methodType
        expect(instance).to.have.property('methodType');
        // expect(instance.methodType).to.be(expectedValueLiteral);
      });
