...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataExtractsEventData', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.DataExtractsEventData();
      });

      it('should create an instance of DataExtractsEventData', function() {
        // TODO: update the code to test DataExtractsEventData
        expect(instance).to.be.a(YodleeCoreApis.DataExtractsEventData);
      });
