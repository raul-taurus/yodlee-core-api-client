  ...
  describe('(package)', function() {
    describe('YodleeError', function() {
      ...
      it('should create an instance of YodleeError', function() {
        // TODO: update the code to test YodleeError
      ...
      it('should have the property referenceCode (base name: "referenceCode")', function() {
        // TODO: update the code to test the property referenceCode
        expect(instance).to.have.property('referenceCode');
        // expect(instance.referenceCode).to.be(expectedValueLiteral);
      });
