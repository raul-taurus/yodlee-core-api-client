...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HoldingTypeListResponse', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.HoldingTypeListResponse();
      });

      it('should create an instance of HoldingTypeListResponse', function() {
        // TODO: update the code to test HoldingTypeListResponse
        expect(instance).to.be.a(YodleeCoreApis.HoldingTypeListResponse);
      });
