...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserSession', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.UserSession();
      });

      it('should create an instance of UserSession', function() {
        // TODO: update the code to test UserSession
        expect(instance).to.be.a(YodleeCoreApis.UserSession);
      });

      it('should have the property userSession (base name: "userSession")', function() {
