...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateAccountRequest', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.UpdateAccountRequest();
      });

      it('should create an instance of UpdateAccountRequest', function() {
        // TODO: update the code to test UpdateAccountRequest
        expect(instance).to.be.a(YodleeCoreApis.UpdateAccountRequest);
      });
