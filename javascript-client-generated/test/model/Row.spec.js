  ...
  describe('(package)', function() {
    describe('Row', function() {
      ...
      it('should create an instance of Row', function() {
        // TODO: update the code to test Row
        expect(instance).to.be.a(YodleeCoreApis.Row);
      });

      it('should have the property fieldRowChoice (base name: "fieldRowChoice")', function() {
        // TODO: update the code to test the property fieldRowChoice
        expect(instance).to.have.property('fieldRowChoice');
        // expect(instance.fieldRowChoice).to.be(expectedValueLiteral);
      });
