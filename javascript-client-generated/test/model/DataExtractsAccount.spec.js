...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataExtractsAccount', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.DataExtractsAccount();
      });

      it('should create an instance of DataExtractsAccount', function() {
        // TODO: update the code to test DataExtractsAccount
        expect(instance).to.be.a(YodleeCoreApis.DataExtractsAccount);
      });
      ...
      it('should have the property isSelectedForAggregation (base name: "isSelectedForAggregation")', function() {
        // TODO: update the code to test the property isSelectedForAggregation
        expect(instance).to.have.property('isSelectedForAggregation');
        // expect(instance.isSelectedForAggregation).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property sourceProviderAccountId (base name: "sourceProviderAccountId")', function() {
        // TODO: update the code to test the property sourceProviderAccountId
        expect(instance).to.have.property('sourceProviderAccountId');
        // expect(instance.sourceProviderAccountId).to.be(expectedValueLiteral);
      });
