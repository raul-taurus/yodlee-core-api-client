...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserResponsePreferences', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.UserResponsePreferences();
      });

      it('should create an instance of UserResponsePreferences', function() {
        // TODO: update the code to test UserResponsePreferences
        expect(instance).to.be.a(YodleeCoreApis.UserResponsePreferences);
      });
