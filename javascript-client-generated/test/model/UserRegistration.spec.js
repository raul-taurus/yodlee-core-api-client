...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserRegistration', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.UserRegistration();
      });

      it('should create an instance of UserRegistration', function() {
        // TODO: update the code to test UserRegistration
        expect(instance).to.be.a(YodleeCoreApis.UserRegistration);
      });
