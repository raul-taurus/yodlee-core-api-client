...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AutoRefresh', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.AutoRefresh();
      });

      it('should create an instance of AutoRefresh', function() {
        // TODO: update the code to test AutoRefresh
        expect(instance).to.be.a(YodleeCoreApis.AutoRefresh);
      });
