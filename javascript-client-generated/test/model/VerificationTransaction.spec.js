...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerificationTransaction', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.VerificationTransaction();
      });

      it('should create an instance of VerificationTransaction', function() {
        // TODO: update the code to test VerificationTransaction
        expect(instance).to.be.a(YodleeCoreApis.VerificationTransaction);
      });
