...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataExtractsEvent', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.DataExtractsEvent();
      });

      it('should create an instance of DataExtractsEvent', function() {
        // TODO: update the code to test DataExtractsEvent
        expect(instance).to.be.a(YodleeCoreApis.DataExtractsEvent);
      });
