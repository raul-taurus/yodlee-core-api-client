...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdatedProviderAccount', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.UpdatedProviderAccount();
      });

      it('should create an instance of UpdatedProviderAccount', function() {
        // TODO: update the code to test UpdatedProviderAccount
        expect(instance).to.be.a(YodleeCoreApis.UpdatedProviderAccount);
      });
