...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionRequest', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.TransactionRequest();
      });

      it('should create an instance of TransactionRequest', function() {
        // TODO: update the code to test TransactionRequest
        expect(instance).to.be.a(YodleeCoreApis.TransactionRequest);
      });
