...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FieldOperation', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.FieldOperation();
      });

      it('should create an instance of FieldOperation', function() {
        // TODO: update the code to test FieldOperation
        expect(instance).to.be.a(YodleeCoreApis.FieldOperation);
      });
