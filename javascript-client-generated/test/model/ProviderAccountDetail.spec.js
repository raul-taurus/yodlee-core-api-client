  ...
  describe('(package)', function() {
    describe('ProviderAccountDetail', function() {
      ...
      it('should create an instance of ProviderAccountDetail', function() {
        // TODO: update the code to test ProviderAccountDetail
      ...
      it('should have the property loginForm (base name: "loginForm")', function() {
        // TODO: update the code to test the property loginForm
        expect(instance).to.have.property('loginForm');
        // expect(instance.loginForm).to.be(expectedValueLiteral);
      });
