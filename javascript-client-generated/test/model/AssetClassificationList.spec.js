...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AssetClassificationList', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.AssetClassificationList();
      });

      it('should create an instance of AssetClassificationList', function() {
        // TODO: update the code to test AssetClassificationList
        expect(instance).to.be.a(YodleeCoreApis.AssetClassificationList);
      });
