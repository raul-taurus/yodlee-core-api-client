...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProviderDetail', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.ProviderDetail();
      });

      it('should create an instance of ProviderDetail', function() {
        // TODO: update the code to test ProviderDetail
        expect(instance).to.be.a(YodleeCoreApis.ProviderDetail);
      });
