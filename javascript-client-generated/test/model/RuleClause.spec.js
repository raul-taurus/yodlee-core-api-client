...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RuleClause', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.RuleClause();
      });

      it('should create an instance of RuleClause', function() {
        // TODO: update the code to test RuleClause
        expect(instance).to.be.a(YodleeCoreApis.RuleClause);
      });
      ...
      it('should have the property ruleClauseId (base name: "ruleClauseId")', function() {
        // TODO: update the code to test the property ruleClauseId
        expect(instance).to.have.property('ruleClauseId');
        // expect(instance.ruleClauseId).to.be(expectedValueLiteral);
      });
