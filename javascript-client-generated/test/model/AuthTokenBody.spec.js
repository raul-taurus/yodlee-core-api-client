...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthTokenBody', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.AuthTokenBody();
      });

      it('should create an instance of AuthTokenBody', function() {
        // TODO: update the code to test AuthTokenBody
        expect(instance).to.be.a(YodleeCoreApis.AuthTokenBody);
      });
