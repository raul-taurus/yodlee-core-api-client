...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AbstractAddress', function() {
      beforeEach(function() {
        instance = new YodleeCoreApis.AbstractAddress();
      });

      it('should create an instance of AbstractAddress', function() {
        // TODO: update the code to test AbstractAddress
        expect(instance).to.be.a(YodleeCoreApis.AbstractAddress);
      });
