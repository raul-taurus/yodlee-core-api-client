...
import {AccountLatestBalance} from './AccountLatestBalance';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('accountBalance'))
        obj.accountBalance = ApiClient.convertToType(data['accountBalance'], [AccountLatestBalance]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/AccountLatestBalance>} accountBalance
 */
AccountBalanceResponse.prototype.accountBalance = undefined;
