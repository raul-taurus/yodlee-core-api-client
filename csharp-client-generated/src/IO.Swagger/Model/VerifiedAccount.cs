...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VerifiedAccount :  IEquatable<VerifiedAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VerifiedAccount" /> class.
        /// </summary>
        /// <param name="fullAccountNumber">fullAccountNumber.</param>
        /// <param name="holder">holder.</param>
        /// <param name="id">id.</param>
        public VerifiedAccount(string fullAccountNumber = default(string), List<AccountHolder> holder = default(List<AccountHolder>), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as VerifiedAccount);
        }

        /// <summary>
        /// Returns true if VerifiedAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of VerifiedAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VerifiedAccount input)
        {
            if (input == null)
                return false;
