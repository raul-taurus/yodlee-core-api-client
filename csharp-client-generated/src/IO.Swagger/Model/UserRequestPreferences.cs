...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UserRequestPreferences :  IEquatable<UserRequestPreferences>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserRequestPreferences" /> class.
        /// </summary>
        ...
        public UserRequestPreferences(string dateFormat = default(string), string timeZone = default(string), CurrencyEnum? currency = default(CurrencyEnum?), LocaleEnum? locale = default(LocaleEnum?))
        {
        ...
        {
            return this.Equals(input as UserRequestPreferences);
        }

        /// <summary>
        /// Returns true if UserRequestPreferences instances are equal
        /// </summary>
        /// <param name="input">Instance of UserRequestPreferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserRequestPreferences input)
        {
            if (input == null)
                return false;
