...
namespace IO.Swagger.Model
{
        ...
        public partial class Transaction :  IEquatable<Transaction>, IValidatableObject
    {
        ...
        public Transaction(Description description = default(Description), Money principal = default(Money), Money interest = default(Money), Money price = default(Money), Money commission = default(Money), Money amount = default(Money), Merchant merchant = default(Merchant), Money runningBalance = default(Money))
        {
