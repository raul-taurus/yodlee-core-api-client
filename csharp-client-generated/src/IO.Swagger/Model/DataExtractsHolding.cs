...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DataExtractsHolding :  IEquatable<DataExtractsHolding>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataExtractsHolding" /> class.
        /// </summary>
        ...
        public DataExtractsHolding(Money unvestedValue = default(Money), Money vestedValue = default(Money), Money price = default(Money), Money value = default(Money), Money accruedInterest = default(Money), Money spread = default(Money), Money accruedIncome = default(Money), Money costBasis = default(Money), Money strikePrice = default(Money))
        {
        ...
        {
            return this.Equals(input as DataExtractsHolding);
        }

        /// <summary>
        /// Returns true if DataExtractsHolding instances are equal
        /// </summary>
        /// <param name="input">Instance of DataExtractsHolding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataExtractsHolding input)
        {
            if (input == null)
                return false;
