...
namespace IO.Swagger.Model
{
        ...
        public partial class UserRequest :  IEquatable<UserRequest>, IValidatableObject
    {
        ...
        public UserRequest(UserRegistration user = default(UserRegistration))
        {
            // to ensure "user" is required (not null)
            if (user == null)
            {
                throw new InvalidDataException("user is a required property for UserRequest and cannot be null");
            }
            else
            {
                this.User = user;
