...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdatedProviderAccount :  IEquatable<UpdatedProviderAccount>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatedProviderAccount" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdatedProviderAccount);
        }

        /// <summary>
        /// Returns true if UpdatedProviderAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatedProviderAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatedProviderAccount input)
        {
            if (input == null)
                return false;
