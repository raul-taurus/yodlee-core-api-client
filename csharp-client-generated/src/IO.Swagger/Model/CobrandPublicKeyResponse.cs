...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CobrandPublicKeyResponse :  IEquatable<CobrandPublicKeyResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CobrandPublicKeyResponse" /> class.
        /// </summary>
        ...
        public string KeyAsPemString { get; private set; }
        ...
        {
            return this.Equals(input as CobrandPublicKeyResponse);
        }

        /// <summary>
        /// Returns true if CobrandPublicKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CobrandPublicKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CobrandPublicKeyResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.KeyAsPemString == input.KeyAsPemString ||
                    (this.KeyAsPemString != null &&
                    this.KeyAsPemString.Equals(input.KeyAsPemString))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KeyAsPemString != null)
                    hashCode = hashCode * 59 + this.KeyAsPemString.GetHashCode();
                return hashCode;
            }
        }
