...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProviderAccountDetail :  IEquatable<ProviderAccountDetail>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProviderAccountDetail" /> class.
        /// </summary>
        /// <param name="preferences">preferences.</param>
        /// <param name="consentId">Consent Id generated through POST Consent.&lt;br&gt;&lt;br&gt;&lt;b&gt;Endpoints&lt;/b&gt;:&lt;ul&gt;&lt;li&gt;GET providerAccounts&lt;/li&gt;&lt;li&gt;POST providerAccounts&lt;/li&gt;&lt;li&gt;PUT providerAccounts/{providerAccountId}&lt;/li&gt;&lt;li&gt;GET providerAccounts/{providerAccountId}&lt;/li&gt;&lt;/ul&gt; (required).</param>
        public ProviderAccountDetail(ProviderAccountPreferences preferences = default(ProviderAccountPreferences), long? consentId = default(long?))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for ProviderAccountDetail and cannot be null");
            }
            else
            {
        ...
        public List<LoginForm> LoginForm { get; private set; }
        ...
        {
            return this.Equals(input as ProviderAccountDetail);
        }

        /// <summary>
        /// Returns true if ProviderAccountDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ProviderAccountDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProviderAccountDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.LoginForm != null &&
                    input.LoginForm != null &&
                    this.LoginForm.SequenceEqual(input.LoginForm)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LoginForm != null)
                    hashCode = hashCode * 59 + this.LoginForm.GetHashCode();
