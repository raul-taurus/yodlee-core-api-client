...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProviderDetail :  IEquatable<ProviderDetail>, IValidatableObject
    {
        /// <summary>
        /// Defines AccountType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProviderDetail" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProviderDetail);
        }

        /// <summary>
        /// Returns true if ProviderDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ProviderDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProviderDetail input)
        {
            if (input == null)
                return false;
