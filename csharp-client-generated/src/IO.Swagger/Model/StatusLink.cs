...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StatusLink :  IEquatable<StatusLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusLink" /> class.
        /// </summary>
        public StatusLink()
        {
        }
        ...
        {
            return this.Equals(input as StatusLink);
        }

        /// <summary>
        /// Returns true if StatusLink instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusLink input)
        {
            if (input == null)
                return false;
